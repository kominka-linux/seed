...
#[cfg(test)]
mod tests {
    use super::{run, Algo, hash_reader};
    ...
    fn hex_hash(algo: Algo, data: &[u8]) -> String {
        hash_reader(&mut data.as_ref(), &algo).unwrap()
    }
    ...
    #[test]
    fn md5_abc() {
        assert_eq!(hex_hash(Algo::Md5, b"abc"), "900150983cd24fb0d6963f7d28e17f72");
    }

    #[test]
    fn md5_long() {
        assert_eq!(
            hex_hash(Algo::Md5, b"abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"),
    ...
    #[test]
    fn sha1_empty() {
        assert_eq!(hex_hash(Algo::Sha1, b""), "da39a3ee5e6b4b0d3255bfef95601890afd80709");
    }

    #[test]
    fn sha1_abc() {
        assert_eq!(hex_hash(Algo::Sha1, b"abc"), "a9993e364706816aba3e25717850c26c9cd0d89d");
    }
